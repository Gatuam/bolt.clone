...
const Nav = () => {
  return (
    <div className="flex w-[100%] h-20 justify-between items-center 
    bg-[#0000] px-10 absolute top-0">
      ...
      <div className=" text-white flex justify-between items-center gap-10">
        <div className="bg-[#3bd5ff19] px-7 py-1 rounded-4xl border border-[#20cfff38] hover:bg-[#86fde9c3] hover:text-neutral-800 cursor-pointer 
