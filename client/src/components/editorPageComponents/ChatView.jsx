...
const ChatView = () => {
  ...
  return (
    <div className="bg-[#00000023] min-h-[98vh] max-w-[99%] mx-auto border border-[#1dd9ff22] p-3 rounded-lg flex flex-col justify-between items-center relative overflow-hidden">
      { }
      <div className="overflow-y-auto px-2 flex-1 flex flex-col gap-4 pr-3 w-full [&::-webkit-scrollbar]:hidden">
        {message.map((msg, i) => (
          <div
            key={i}
            className={`${msg.role === "ai" && "self-end w-full max-w-[80%]"
